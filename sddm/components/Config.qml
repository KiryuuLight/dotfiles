...
QtObject {
    ...
    property string clockFontFamily: config.stringValue("LockScreen.Clock/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family used for the clock.
    ...
    property string dateFontFamily: config.stringValue("LockScreen.Date/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family used for the date.
    ...
    property string lockMessageFontFamily: config.stringValue("LockScreen.Message/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family used for the custom message.
    ...
    property string usernameFontFamily: config.stringValue("LoginScreen.LoginArea.Username/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family used for the username.
    ...
    property string passwordInputFontFamily: config.stringValue("LoginScreen.LoginArea.PasswordInput/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the password field.
    ...
    property string loginButtonFontFamily: config.stringValue("LoginScreen.LoginArea.LoginButton/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the label of the login button/
    ...
    property string spinnerFontFamily: config.stringValue("LoginScreen.LoginArea.Spinner/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the text to be displayed with the spinning icon.
    ...
    property string warningMessageFontFamily: config.stringValue("LoginScreen.LoginArea.WarningMessage/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the warning message.
    ...
    property string menuAreaButtonsFontFamily: config.stringValue("LoginScreen.MenuArea.Buttons/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the menu buttons.
    ...
    property string menuAreaPopupsFontFamily: config.stringValue("LoginScreen.MenuArea.Popups/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the popups.
    ...
    property string tooltipsFontFamily: config.stringValue("Tooltips/font-family") || "JetBrainsMono Nerd Font" // @desc:Font family of the tooltips.
